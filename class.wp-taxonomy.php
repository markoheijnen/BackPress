...
class WP_Taxonomy {
	...
	/**
	 * count_terms() - Count how many terms are in Taxonomy
	 *
	...
	/**
	 * delete_term() - Removes a term from the database.
	 *
	...
	/**
	 * insert_term() - Adds a new term to the database. Optionally marks it as an alias of an existing term.
	 *
	...
	/**
	 * unique_term_slug() - Will make slug unique, if it isn't already
	 * 
	...
	/**
	 * update_term() - Update term based on arguments provided
	 *
	...
	/**
	 * update_term_count() - Updates the amount of terms in taxonomy
	 * 
